...
const resources = {
  en: {
    translation: {
      ...
      'processModelName':'Modal Name',
      'processIp':'IP',
      'processPrinterName':'Printer Name',
      'processType':'Type',
  ...
  ko: {
    translation: {
      ...
      'processDate':'처리일시',
      'processNo':'아니요',
      'processSearchDate':'검색 날짜',
      'processRegistration':'등록 파일/나피 범위',
      'processNormalDetected':'정상 감지됨',
      'processAbnormalDetected':'이상 감지됨',
      'processNotDetected':'아니다 감지됨',
      'processSearchBtn':'검색',
      'processStatus':'상태',
      'processSerialNumber':'일련 번호',
      'processModelName':'모델 이름',
      'processIp':'나피',
      'processPrinterName':'인쇄기 이름',
      'processType':'구분',
      'processMessage':'메시지',
