    ...
    return (
        <>
            <div className="d-flex f-align-center f-justify-between mb-8">
                <Typography variant="h4">{t("Max Thread Count for Local Agent Device Registration")}</Typography>
            </div>
            <Paper elevation={4}>
                <div className="AgentCollectorMainDiv">
                    <div className="AgentCollectorInnerDivs">
                        <strong >{t('Device Registration Max Thread Count')}</strong>
                        <TextField
